import sys
import os
from PyQt5.Qt import QUrl, QFont
...
from PyQt5.QtWidgets import QApplication, QWidget, QListWidget, QLabel, QSlider, QPushButton, QHBoxLayout, \
    QVBoxLayout, QDesktopWidget, QPlainTextEdit
...
class player(QWidget):
    ...
    def __init__(self, title, file_list):
        ...
        self.dictation = QPlainTextEdit(self)
    ...
    def widget_init(self):
        ...
        self.list_widget.addItems([each.split("\\")[-1] for each in self.media_list])
    ...
    def layout_init(self):
        ...
        self.all_h_layout.addLayout(self.all_v_layout)
        self.all_h_layout.addWidget(self.dictation)
    ...
    def style(self):
        self.dictation.setProperty("name", "dict")
        qssStyle = '''
            * {
        ...
        qssStyle = '''
            ...
            font-size: 26px;
        '''
        self.dictation.setStyleSheet(qssStyle)
        self.center(self)
